...
def index(request):
  ...
  final_list_suggestion=[x for x in list(new_suggestion_list) if (x not in list(current_user))]
  random.shuffle(final_list_suggestion)

  username_profile=[]
  username_profile_list=[]
  for users in final_list_suggestion:
